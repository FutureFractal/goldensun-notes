...
This repository can be viewed and edited using Markdown editing software like silverbullet (https://silverbullet.md/) and obsidian (https://obsidian.md/).
...
Find out some other things by me through [delta-trace](https://github.com/deltatraced/delta-trace/tree/webview).

Check out my [[now]] page for what I am currently up to for this project.